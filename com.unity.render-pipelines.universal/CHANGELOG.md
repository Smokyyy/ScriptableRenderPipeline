...
- Fixed issue where using DOF at the same time as Dynamic Scaling would cause the depth buffer to smaple with incorrect UVs. [case 1225467](https://issuetracker.unity3d.com/product/unity/issues/guid/1225467/)
